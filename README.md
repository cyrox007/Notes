...
3. подтвердить fresh backup/restore drill, exact published 1.0.1 → 1.0.2 upgrade/rollback, обязательный Admin E2E `v1.0.2 → 1.0.3`, production trust canaries, Windows compatibility CI и финальную ручную OSPanel 5.2.2 acceptance;
