...
- Добавлен настоящий browser E2E: отдельная установка exact `v1.0.2`, реальная MySQL-схема и суперадминистратор, временно подписанный канал, нажатие «Установить обновление», фактическая смена версии на `1.0.3`, committed-журнал транзакции и post-update healthcheck.
