...
### Исправления 1.0.1 / интеграции Workspace
...
### Stable runtime / граница безопасности
...
### Доставка / доказательная база релиза
...
### База данных / развёртывание / проверка
...
### Управляемые приглашения / безопасность
...
### Hotfix развёртывания WebSocket
...
### Рабочий baseline / целостность данных
...
### Усиление после первоначального baseline 0.10
