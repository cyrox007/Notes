				...
				<form name="changeProfile" action="" method="post" enctype="multipart/form-data">
					<div class="profile__card-info--edit--form-group">
						...
						<input class="profile__card-info--edit--set-input" type="text" name="set-user-name"
							id="user-name" placeholder="Введите имя">
					</div>
					<div class="profile__card-info--edit--form-group">
						<label for="">Отчество: </label>
						<input class="profile__card-info--edit--set-input" type="text" name="set-user-patronymic"
							id="user-patronymic" placeholder="Введите отчество">
					</div>
					<div class="profile__card-info--edit--form-group">
						<label for="">Фамилия: </label>
						<input class="profile__card-info--edit--set-input" type="text" name="set-user-surname"
							id="user-surname" placeholder="Введите фамилию">
					</div>
					<div class="profile__card-info--edit--form-group">
						<label for="">Телефон: </label>
						<input class="profile__card-info--edit--set-input" type="text" name="set-user-phone"
							id="user-phone" placeholder="Введите свой номер телефона">
					</div>
					...
					<div class="profile__card-info--edit--form-group">
						...
						<input class="profile__card-info--edit--set-input" type="text" name="set-user-position"
							id="user-position" placeholder="Введите вашу должность">
					</div>
					<div class="profile__card-info--edit--form-group">
						<label for="">Отдел: </label>
						<input class="profile__card-info--edit--set-input" type="text" name="set-user-deportament"
							id="user-deportament" placeholder="Укажите ваш отдел">
					</div>
					<div class="profile__card-info--edit--form-group">
						<label for="">Телефон офиса: </label>
						<input class="profile__card-info--edit--set-input" type="text" name="set-office-phone"
							id="user-office-phone" placeholder="Укажите телефон офиса">
					</div>
