...
<section class="profile profile--hub">
    ...
    <div class="profile__column-left">
        <div class="profile__card-avatar">
            ...
            <?php if ($avatarUrl !== ''): ?>
                <form class="profile__avatar-delete" action="<?= $view->e($view->route('profile-avatar-delete')) ?>" method="post" onsubmit="return confirm('Удалить фото профиля?');">
                    <?= $view->csrfInput() ?>
        ...
        <div class="profile__card-info">
            ...
            <div class="profile__card-info--edit" id="profile-account-settings">
                ...
                <section class="profile__danger-zone">
                    ...
                    <form name="deleteUser" action="<?= $view->e($view->route('profile-delete')) ?>" method="post" onsubmit="return confirm('Деактивировать аккаунт? Вход в систему будет заблокирован.');">
                        <?= $view->csrfInput() ?>
