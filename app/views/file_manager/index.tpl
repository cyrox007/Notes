    ...
    <div class="file-manager__content">
        {if empty($files)}
            <div class="file-manager__empty">
                ...
                <p>Папка пуста</p>
                <p style="margin-top: 10px; font-size: 14px; color: #999;">Создайте папку или загрузите файл, чтобы начать</p>
            </div>
        {else}
            <div class="file-manager__grid">
                {foreach $files as $file}
                    <div class="file-manager__item" data-id="{$file->id}" data-type="{$file->type}" data-name="{$file->name}" data-extension="{$file->extension}">
