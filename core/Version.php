...
class Version 
{
     ...
     * История версий:
     *
     * ### 0.10.0-alpha (16 мая 2026) - File Manager & BEM Template Refactoring
     *  **Основные изменения:**
     *  - **Файловый менеджер**:
     *  - Переписан шаблон файлового менеджера по БЭМ-методологии
     *  - Добавлены модификаторы для использования в шаблоне
     *  - Исправлено отображение файлов и путей к файлам
     *  - Корректировка путей при чтении и удалении файла
     *  - Исправлена ошибка определения типа при просмотре файла
     *  - Игнорирование папки загрузки
     *  - Исправлены ошибки загрузки файла
     *  - **Шаблонизация и роутинг**:
     *  - Исправление вызовов из-за изменения имён классов в шаблоне
     *  - Исправлена ошибка роутера с типизацией параметров
     *  - Исправлено неправильное чтение параметров в шаблоне файлового менеджера
     *  - **База данных и ORM**:
     *  - Корректировка модели файлов
     *  - Исправление логики определения корневой папки
     *  - Исправлена ошибка обработки оператора IS при проверке на NULL
     *  - Исправлена работа с корневой директорией в базе
     ...
     * 
     * 0.8.0-alpha - Major Update: Task & File Management
     ...
     */
    public const VERSION_CODE = 1000; // 0.10.0 = 1000
