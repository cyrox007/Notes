-- Workspace Organizer 0.14 module lifecycle registry.
-- configured_state records operator/package intent; effective_state records the
-- runtime-eligible result after compatibility reconciliation.
